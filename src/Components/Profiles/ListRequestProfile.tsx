  ...
  return (
    <View className='w-full flex flex-row items-center p-1 py-3 border-y-2 border-y-neutral-800'>
      ...
      <View className='ml-3 flex-1'>
        <Text className='text-white font-bold text-base'>{request?.name}</Text>
        <Text className='text-white text-xsm'>{request.username} invited you to join </Text>
      </View>
      <TouchableOpacity
...
export default ListRequestProfile
